...
// SpotlightButton (kept inline to preserve hero UI exactly)
    ...
    <div className="relative min-h-screen bg-[#05050a] text-slate-200 font-sans selection:bg-pink-500/30 overflow-x-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-base md:text-xl text-slate-400 mb-8 max-w-xl mx-auto leading-relaxed font-light">
              ...
              , or join the global community to find your vibe anywhere.
            </p>
      ...
      <div className="py-10 border-y border-white/5 bg-white/[0.02] backdrop-blur-sm relative z-10">
        <div className="max-w-6xl mx-auto px-6 flex flex-wrap justify-center md:justify-between gap-8 items-center text-center md:text-left">
          <p className="text-sm text-white/40 font-medium uppercase tracking-widest">Trending Campuses:</p>
          {["NYU", "UCLA", "Stanford", "MIT", "Oxford"].map((school, i) => (
            <span key={i} className="text-lg font-semibold text-white/70 hover:text-white transition-colors cursor-default">{school}</span>
          ))}
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <TiltCard className="group h-[450px] rounded-3xl overflow-hidden bg-[#0a0508] border border-white/10">
              ...
              <div className="relative z-20 p-8 h-full flex flex-col justify-end">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Vibe Check Algorithm</h3>
            ...
            <TiltCard className="group h-[450px] rounded-3xl overflow-hidden bg-[#0a0508] border border-white/10 md:-mt-12">
              ...
              <div className="relative z-20 p-8 h-full flex flex-col justify-end">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Real People Only</h3>
                <p className="text-white/60 leading-relaxed">
            ...
            <TiltCard className="group h-[450px] rounded-3xl overflow-hidden bg-[#0a0508] border border-white/10">
              ...
              <div className="relative z-20 p-8 h-full flex flex-col justify-end">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Campus Circle</h3>
                <p className="text-white/60 leading-relaxed">
                  Have a .edu email? Set your profile to{" "}
                  <span className="text-white font-medium">Private Mode</span> to
      ...
      <section className="py-24 overflow-hidden bg-gradient-to-b from-transparent to-black">
        ...
        <Marquee direction={1}>
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="w-[350px] p-6 rounded-2xl bg-zinc-900/60 backdrop-blur-md border border-white/5 hover:border-pink-500/30 transition-colors">
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10 px-6">
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight">Ready to find <br /> your person?</h2>
          <div className="flex justify-center">
            <SpotlightButton onClick={() => navigate("/signup")} className="text-lg px-10 py-5">
              Join Your Campus
            </SpotlightButton>
          </div>
        </div>
